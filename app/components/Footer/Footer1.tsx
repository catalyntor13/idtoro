      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-bold">IdToro</h3>
            <p className="text-sm text-muted-foreground">
              IT solutions for organizations that demand security, customization, and control.
            </p>
          </div>
          <div className="space-y-4">
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">© {currentYear} IdToro Enterprise. All rights reserved.</p>
